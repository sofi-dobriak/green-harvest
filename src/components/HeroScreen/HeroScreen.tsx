...
const HeroScreen = () => {
  return (
    <section className='xl:flex xl:items-center'>
      <Container>
        <h1 className='uppercase font-semibold text-[46px] md:text-[76px] leading-none max-w-[335px] md:max-w-[704px] text-[#fbfbfb] mb-5 md:mb-6 xl:mb-32 pt-[100px]'>
          organic vegetables to your diet today!
        </h1>

        <p className='font-medium text-sm md:text-base leading-[1.43] md:leading-[1.25] text-[#fbfbfb] max-w-[335px] md:max-w-[604px] mb-10 md:mb-13 '>
