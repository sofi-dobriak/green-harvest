      ...
      <Container>
        ...
        {!isDesktop && (
          <div className='md:max-w-[700px]'>
            <p className='bg-[#576f35] text-[#fbfbfb] rounded-xl font-semibold text-[48px] max-w-[340px] md:max-w-[704px] md:text-[64px]  uppercase leading-[1] '>
              Discount up to 40%!
            </p>

            <p className='font-semibold text-[48px] md:text-[64px] uppercase text-[#141414] leading-[1]'>
